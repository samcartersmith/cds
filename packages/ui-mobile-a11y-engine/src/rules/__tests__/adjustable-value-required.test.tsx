/* eslint-disable react-native-a11y/has-valid-accessibility-value */
// we are disabling this rule, because this test file verifies that those same eslint errors are caught programmatically along with additional requirements for accessibilityValue
import React from 'react';
import Slider from '@react-native-community/slider';

import check from '../../engine';
import rule from '../adjustable-value-required';

const run = (component: React.ReactElement<unknown>) => {
  return check(component, { rules: [rule] });
};
describe('is-adjustable-value-required tests', () => {
