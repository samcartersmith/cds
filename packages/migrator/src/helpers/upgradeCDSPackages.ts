...
import { getProjects, output, updateJson } from '@nx/devkit';
import semver from 'semver';

import type { CdsDependencyCheck } from './checkHasCdsDependency';
import { checkHasCdsDependency } from './checkHasCdsDependency';
import { logDebug } from './loggingHelpers';
import type { DepsToAddMap, PackageName, PackageWithVersion } from './types';
import { packageNames } from './types';
