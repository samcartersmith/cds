...
const PACKAGE_SCOPE_MAPPINGS: Record<string, string> = {
  '@coinbase/cds-common': '@cbhq/cds-common',
  '@coinbase/cds-icons': '@cbhq/cds-icons',
  '@coinbase/cds-illustrations': '@cbhq/cds-illustrations',
  '@coinbase/cds-lottie-files': '@cbhq/cds-lottie-files',
  '@coinbase/cds-mcp-server': '@cbhq/cds-mcp-server',
  '@coinbase/cds-mobile': '@cbhq/cds-mobile',
  '@coinbase/cds-mobile-visualization': '@cbhq/cds-mobile-visualization',
  '@coinbase/cds-web': '@cbhq/cds-web',
  '@coinbase/cds-web-visualization': '@cbhq/cds-web-visualization',
  '@coinbase/cds-utils': '@cbhq/cds-utils',
  '@coinbase/eslint-plugin-cds': '@cbhq/eslint-plugin-cds',
  '@coinbase/ui-mobile-playground': '@cbhq/ui-mobile-playground',
};
