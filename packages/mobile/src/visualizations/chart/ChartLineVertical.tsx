...
import { maskOpacity } from '@cbhq/cds-common/src/tokens/sparkline';
import { ChartLineVerticalProps } from '@cbhq/cds-common/src/types/SparklineInteractiveBaseProps';
