...
const PatternTagDisclosureLowFrictionScreen = () => {
  ...
  return (
    <ExampleScreen>
      <Example title="Pattern Tag - Low-Friction Disclosure">
...
export default PatternTagDisclosureLowFrictionScreen;
