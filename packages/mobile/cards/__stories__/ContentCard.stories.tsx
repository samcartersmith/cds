  ...
  contentBodyProps: {
    ...
    label: (
      <HStack alignItems="flex-end" flexWrap="wrap" gap={0.5}>
        ...
        <TextLabel2 color="positive">↗ 6.37%</TextLabel2>
      </HStack>
    ),
    media: (
      <Image
...
const CarouselItem = () => (
  <VStack position="relative">
    ...
    <VStack bottom={16} gap={1} left={16} position="absolute">
      <TextHeadline color="secondary">Break the cycle</TextHeadline>
      <TextLegal color="secondary">24M views</TextLegal>
    </VStack>
  </VStack>
);
  ...
  return (
    <ExampleScreen>
      <Example spacingHorizontal={0}>
        <TextTitle3 spacingHorizontal={3}>Full Example</TextTitle3>
        <ContentCard>
      ...
      <Example spacingHorizontal={0}>
        <TextTitle3 spacingHorizontal={3}>Full Example with mediaPosition bottom</TextTitle3>
        <ContentCard>
          <ContentCardHeader {...exampleProps.contentHeaderProps} />
      ...
      <Example spacingHorizontal={0}>
        <TextTitle3 spacingHorizontal={3}>Full Example with mediaPosition right</TextTitle3>
        <ContentCard>
          <ContentCardHeader {...exampleProps.contentHeaderProps} />
          <ContentCardBody
      ...
      <Example spacingHorizontal={0}>
        <TextTitle3 spacingHorizontal={3}>Full Example with product component</TextTitle3>
        <ContentCard>
          <ContentCardHeader {...exampleProps.contentHeaderProps} />
      ...
      <Example spacingHorizontal={0}>
        <TextTitle3 spacingHorizontal={3}>
        ...
        <ContentCard>
          <ContentCardHeader
            ...
            avatar={null}
            end={<TextLegal color="foregroundMuted">Updated 1hr ago</TextLegal>}
            meta={null}
      ...
      <Example spacingHorizontal={0}>
        <TextTitle3 spacingHorizontal={3}>Full Example with IconCounterButton</TextTitle3>
        <ContentCard>
          <ContentCardHeader {...exampleProps.contentHeaderProps} />
          <ContentCardBody {...exampleProps.contentBodyProps} media={null} />
          <ContentCardFooter>
