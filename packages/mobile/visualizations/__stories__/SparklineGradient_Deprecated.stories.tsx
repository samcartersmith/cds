...
const PressableOpacityScreen = () => {
  return (
    <ExampleScreen>
      <Example title="SparklineGradient (moved to cds-mobile-visualization)">
      ...
      <Example title="SparklineGradientWithArea (moved to cds-mobile-visualization)">
      ...
      <Example title="SparklineGradientWithScale (moved to cds-mobile-visualization)">
        {pricesWithScalingFactor.map((item) => (
          <SparklineScalingExample key={item.yAxisScalingFactor} {...item} />
        ))}
      </Example>
      <Example title="SparklineGradientWithAreaAndScale (moved to cds-mobile-visualization)">
        {pricesWithScalingFactor.map((item) => (
