...
pngLight=`compressPNGs "${ROOTDIRPATH}eng/shared/design-system/codegen/illustrations/images/png-light/"`
pngDark=`compressPNGs "${ROOTDIRPATH}eng/shared/design-system/codegen/illustrations/images/png-dark/"`
echo $pngLight
echo $pngDark
...
cp -rf "${ROOTDIRPATH}eng/shared/design-system/codegen/illustrations/images/" "${ROOTDIRPATH}eng/shared/design-system/codegen/illustrations/static-assets/assets/design-system/illustrations/"
