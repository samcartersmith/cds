...
import { autoThemeClassName } from './themes/css/auto';
...
export const IllustrationExample = memo(function IllustrationExample({
  ...
  return (
    <VStack alignItems="flex-start" gap={2}>
      ...
      <ThemeProvider theme={themeMap.dark}>
        <Box background="background">{children}</Box>
      </ThemeProvider>
    </VStack>
  );
...
export const Test = () => {
  ...
  const [themeClassName, setThemeClassName] = useState<string>(autoThemeClassName);
  const [theme, setTheme] = useState<keyof typeof themeMap | null>('auto');
  ...
  return (
    <div className={cx(globalStyles, themeClassName)}>
      <ThemeProvider theme={theme ? themeMap[theme] : undefined}>
        <HStack>
          <VStack alignItems="flex-start" gap={1} paddingBottom={2}>
            ...
            <button onClick={() => setTheme('auto')} type="button">
              Auto inline theme
            </button>
            <button onClick={() => setTheme(null)} type="button">
              Unset inline theme
            </button>
            <button onClick={() => setThemeClassName(autoThemeClassName)} type="button">
              Set auto classname theme
            </button>
            <button onClick={() => setThemeClassName('')} type="button">
              Unset classname theme
            </button>
          </VStack>
          <VStack>
            <Box>
              Inline theme: &nbsp;
              <strong>{JSON.stringify(Boolean(theme))}</strong>
            </Box>
            <Box>
              Classname theme: &nbsp;
              <strong>{JSON.stringify(Boolean(themeClassName))}</strong>{' '}
            </Box>
          </VStack>
        </HStack>
        <Button
        ...
        <VStack font="display1">
          ...
          <Divider />
          <VStack>
            <Box textDecoration="none">none</Box>
            ...
            <Box textDecoration="underline overline">underline overline</Box>
            <Box textDecoration="underline double">underline double</Box>
          </VStack>
          <VStack gap={1}>
        ...
        {hiddenStories && (
          <>
            ...
            <VStack background="background" gap={2} padding={2}>
              ...
              Custom End Buttons
              <HStack gap={2}>
                <Button end={<Icon color="textForeground" name="caretRight" size="s" />}>
                  Test
                </Button>
                <Button
                  end={<Icon color="textForeground" name="add" size="s" />}
          ...
          <VStack gap={2}>
            ...
            <Box width={300}>
              <Text as="p" font="body" numberOfLines={2}>
                ...
                substantial risk that you lose money buying, selling, holding, or investing in
                digital currencies. You should carefully consider whether trading or holding Digital
            ...
            <Box background="backgroundAlternate" width={300}>
              <Text as="p" font="body" overflow="truncate">
                TextOverflow Ellipsis: As with any asset, the value of Digital Currencies can go up
                or down and there can be a substantial risk that you lose money buying, selling,
                ...
                condition. Coinbase is not registered with the U.S. Securities and Exchange
                Commission and does not offer securities services in the United States or to U.S.
                persons.
              </Text>
            </Box>
            <Box background="backgroundAlternate" height={30} width={300}>
              <Text as="p" font="body" overflow="clip">
                TextOverflow Clip: Crypto address 0xf847047c69726b4049a5b866c8fa37cfe4ed614f. As
                with any asset, the value of Digital Currencies can go up or down and there can be a
                substantial risk that you lose money buying, selling, holding, or investing in
                digital currencies. You should carefully consider whether trading or holding Digital
                Currencies is suitable for you in light of your financial condition. Coinbase is not
