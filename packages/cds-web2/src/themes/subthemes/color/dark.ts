...
export const darkColorTheme = {
  color: {
    ...
    backgroundSecondaryWash: 'rgb(var(--gray0))', // TO DO confirm correct colors
    backgroundNegative: 'rgb(var(--red60))',
    backgroundNegativeWash: 'rgb(var(--red0))',
    backgroundPositive: 'rgb(var(--green60))', // TO DO: confirm correct colors
    ...
    backgroundPositiveHover: 'rgb(var(--green60))', // TO DO: confirm correct colors
    backgroundPositivePressed: 'rgb(var(--green60))',
    backgroundPositiveDisabled: 'rgb(var(--green60))',
    // Line
    ...
    // Elevation
    backgroundElevation1: 'rgb(var(--gray5))',
    backgroundElevation2: 'rgb(var(--gray10))',
    // Icon
