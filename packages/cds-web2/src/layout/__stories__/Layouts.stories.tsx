...
import { Grid, type GridProps, type GridDefaulElement } from '../Grid';
import { GridColumn } from '../GridColumn';
import { HStack, type HStackProps, type HStackDefaultElement } from '../HStack';
...
export const Examples = () => {
  return (
    <VStack>
      <Text font="display1" as="h1" paddingBottom={3}>
        Explicit Layouts
      </Text>
      <Text font="headline" as="h2" paddingBottom={4}>
        Explicit layouts let you declare every track size to create custom layouts.
      </Text>
      <Text font="display2" as="h3" paddingBottom={2}>
        Flexbox
      </Text>
      <VStack gap={4}>
        <Example
      ...
      <Divider paddingY={4} />
      <Text font="display2" as="h2" paddingBottom={2}>
        Grid
      </Text>
      <Text font="body" as="p" paddingBottom={2}>
      ...
      <VStack gap={4}>
        ...
        <Example
          description={
            <VStack gap={1}>
              ...
              <Text font="title4" as="h4" paddingTop={2}>
                Tradeoffs
              </Text>
              <ul>
                <Text font="body" as="li">
        ...
        <VStack>
          ...
          <VStack gap={4}>
            ...
            <Text font="body" as="p" paddingBottom={1}>
