...
export const Examples = () => {
  return (
    <VStack>
      <Text as="h1" font="display1" paddingBottom={3}>
        Explicit Layouts
      </Text>
      <Text as="h2" font="headline" paddingBottom={4}>
        Explicit layouts let you declare every track size to create custom layouts.
      </Text>
      <Text as="h3" font="display2" paddingBottom={2}>
        Flexbox
      </Text>
      <VStack gap={4}>
        <Example
      ...
      <Divider paddingY={4} />
      <Text as="h2" font="display2" paddingBottom={2}>
        Grid
      </Text>
      <Text as="p" font="body" paddingBottom={2}>
      ...
      <VStack gap={4}>
        ...
        <Example
          description={
            <VStack gap={1}>
              ...
              <Text as="h4" font="title4" paddingTop={2}>
                Tradeoffs
              </Text>
              <ul>
                <Text as="li" font="body">
        ...
        <VStack>
          ...
          <VStack gap={4}>
            ...
            <Text as="p" font="body" paddingBottom={1}>
