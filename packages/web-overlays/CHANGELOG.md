...
`@cbhq/cds-web-overlays` adheres to [Semantic Versioning](https://semver.org/spec/v2.0.0.html).

<!-- template-start -->

## 0.0.23 (1/24/2024 PST)
...
- [internal] AppSwitcher: add dense story example.
