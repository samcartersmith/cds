...
const allowedRoles = ['button', 'link', 'imagebutton', 'radio', 'switch'];
...
const rule: Rule = {
  ...
  help: {
    problem:
      "This component is pressable but the user hasn't been informed that it behaves like a button/link/radio/switch",
