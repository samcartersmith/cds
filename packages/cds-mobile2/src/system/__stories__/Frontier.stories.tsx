  ...
  <ExampleScreen>
    <Example title="Frontier Changes">
      <VStack gap={3} paddingX={2} paddingY={3}>
        ...
        <VStack background="background" borderRadius={400} elevation={1} gap={2} padding={2}>
          <TextBody paddingBottom={3}>
            Secondary palette is unchanged when the parent has an elevation of 1
          </TextBody>
          <Button variant="secondary">Secondary button</Button>
        </VStack>
        <VStack background="background" borderRadius={400} elevation={2} gap={2} padding={2}>
          <TextBody paddingBottom={3}>
            Secondary palette is unchanged when the parent has an elevation of 2
          </TextBody>
          <Button variant="secondary">Secondary button</Button>
        </VStack>
        <VStack bordered background="background" borderRadius={400} gap={2} padding={2}>
          <TextBody paddingBottom={3}>
