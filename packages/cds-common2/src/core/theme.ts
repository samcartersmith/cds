...
export namespace ThemeVars {
  ...
  export type Color =
    ...
    | 'backgroundSecondary'
    | 'backgroundSecondaryWash'
    | 'backgroundNegative'
    | 'backgroundNegativeWash'
    | 'backgroundPositive'
    | 'backgroundPositiveWash'
    | 'backgroundWarning'
