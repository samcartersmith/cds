...
- Optional: the designer may specify a product area (Base, Growth, Taxes, Account restrictions, Onboarding, Scam Prevention, etc.). If specified, apply that product module's overrides. If not specified, apply general (Retail) rules from files 01–09.
