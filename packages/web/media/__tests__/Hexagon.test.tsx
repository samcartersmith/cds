...
describe('HexagonBorder', () => {
  it('passes accessibility', async () => {
    expect(await renderA11y(<HexagonBorder strokeColor="blue" size="m" />)).toHaveNoViolations();
  });

  it('renders with the correct standard transforms', () => {
    render(<HexagonBorder strokeColor="blue" size="m" testID={TEST_ID} />);
  ...
  it('renders with the correct offset transforms', () => {
    render(<HexagonBorder size="l" offset strokeColor="var(--primary)" testID={TEST_ID} />);
