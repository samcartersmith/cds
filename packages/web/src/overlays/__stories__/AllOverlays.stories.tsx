...
CompositeOverlays.parameters = { percy: { enableJavaScript: true } };
...
CompositeOverlaysWithPortal.parameters = { percy: { enableJavaScript: true } };

export const CompositeOverlaysWithoutPortal = () => <CompositeOverlays disablePortal />;
CompositeOverlaysWithoutPortal.parameters = { percy: { enableJavaScript: true } };
