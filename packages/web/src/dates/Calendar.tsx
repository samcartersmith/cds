...
const CalendarPressable = memo(
  forwardRef<Element, PressableInternalProps>(
    ({ className, borderRadius = 'roundedFull', width = 40, height = 40, ...props }, ref) => (
      <Pressable
        ref={ref}
        borderRadius={borderRadius}
        className={cx(display.flex, alignItems.center, justifyContent.center, className)}
        height={height}
        width={width}
        {...props}
      />
      ...
      const calendarDayButton = useMemo(
        () => (
          <CalendarPressable
            ...
            background={active ? 'primary' : 'background'}
            borderColor={isToday ? 'primary' : undefined}
          ...
          >
            <TextBody
              as="span"
              color={active ? 'primaryForeground' : highlighted ? 'primary' : undefined}
            >
              {date.getDate()}
            </TextBody>
          </CalendarPressable>
          ...
          >
            ...
            {!hideControls && (
              <HStack gap={1} offsetEnd={1}>
                ...
                >
                  <Icon color="foreground" name="backArrow" size="s" />
                </CalendarPressable>
                <CalendarPressable
                ...
                >
                  <Icon color="foreground" name="forwardArrow" size="s" />
                </CalendarPressable>
              </HStack>
            )}
          </HStack>
