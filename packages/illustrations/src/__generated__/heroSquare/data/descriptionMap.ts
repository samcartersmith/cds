...
const descriptionMap: Record<string, string[]> = {
  ...
  clipboard: ['refresh', 'reviewInfo', 'coinbaseOneWaitlist', 'verifyInfo', 'onTheList'],
  verify: [
    'refresh',
    'verifyEmail',
    'idCard',
  ...
  info: ['refresh', 'reviewInfo', 'verifyInfo', 'processing', 'storage', 'indexer'],
  information: ['refresh', 'reviewInfo', 'verifyInfo', 'processing', 'cloudBacking', 'storage'],
  document: [
    'refresh',
    'taxesDetails',
    'documentCertified',
  ...
  concern: ['refresh', 'verifyInfo', 'errorApp500', 'docError', 'coinbaseCardIssue'],
  '⚠️': [
    'refresh',
    'verifyInfo',
    'errorApp500',
