...
const descriptionMap: Record<string, string[]> = {
  ...
  multi: ['multiplePortfolios', 'namePortfolio'],
  many: ['multiplePortfolios', 'namePortfolio'],
  ...
  new: ['multiplePortfolios', 'coinbaseRedesigned', 'notificationsAndUpdates'],
  select: [
    'multiplePortfolios',
    'namePortfolio',
    'cardBoosted',
  ...
  connect: ['coinbaseOneUSDCBig', 'routingAccount', 'yourContacts', 'ledgerPlugin'],
  ...
  people: ['referralsBitcoin', 'yourContacts', 'referralsAvatars', 'referralsCoinbaseOne'],
  profile: [
    'referralsBitcoin',
    'accountUnderReview',
    'referralsAvatars',
  ...
  information: ['reviewInfo', 'verifyInfo', 'processing', 'cloudBacking'],
  issue: [
    'reviewInfo',
    'verifyInfo',
    'errorApp500',
