...
const descriptionMap: Record<string, string[]> = {
  ...
  swap: ['tradeGeneral', 'usdtToUSDC', 'tradeImmediately', 'realToUSDC'],
  coin: [
    'tradeGeneral',
    'usdtToUSDC',
    'coinbaseOneAirdrop',
  ...
  start: ['usdtToUSDC', 'startToday', 'tradeImmediately', 'readyToTrade', 'realToUSDC'],
  today: ['usdtToUSDC', 'startToday', 'tradeImmediately', 'realToUSDC'],
  currency: [
    'usdtToUSDC',
    'whyNotBoth',
    'holdCrypto',
  ...
  usdc: ['usdtToUSDC', 'coinbaseOneUSDCBig', 'realToUSDC'],
  convert: ['usdtToUSDC', 'realToUSDC', 'cbbtc'],
  stablecoin: ['usdtToUSDC', 'stablecoin', 'realToUSDC'],
  stable: ['usdtToUSDC', 'stableValue', 'stablecoin', 'realToUSDC'],
  ...
  access: ['privateKey', 'yourContacts', 'ledgerAccess', 'ethereumToWallet', 'unlockKey'],
  secure: [
    'privateKey',
    'coinbaseIsDown',
