...
const descriptionMap: Record<string, string[]> = {
  ...
  BTC: ['freeBtc', 'referralsBitcoin', 'bigBtc', 'bitcoinGlobe'],
  earn: [
    'freeBtc',
    'earnToLearn',
    'ethStakingUpsell',
  ...
  'connecting dots': ['layerOne', 'decentralization', 'layerTwo'],
  circle: [
    'layerOne',
    'cryptoForBeginners',
    'earnToLearn',
  ...
  decentralization: ['layerOne', 'decentralization', 'layerTwo'],
  ...
  access: ['unlockKey', 'yourContacts', 'ledgerAccess', 'ethereumToWallet', 'privateKey'],
  verify: [
    'verifyEmail',
    'idCard',
    'verifyInfo',
  ...
  folder: ['storage', 'cryptoPortfolio', 'walletFlyEmptyState', 'squidEmptyState'],
  folders: ['storage'],
  ...
  data: ['storage', 'idVerificationSecure', 'web3MobileSetupSuccess', 'cloudBacking'],
  info: ['storage', 'reviewInfo', 'verifyInfo', 'processing', 'indexer'],
  ...
  correct: ['documentCertified', 'selectCorrectCrypto', 'faceMatchReal', 'processing', 'success'],
  ...
  yield: ['earnMore', 'holdCrypto', 'defiRisk', 'earnGrowth', 'stakingMissedReturns'],
