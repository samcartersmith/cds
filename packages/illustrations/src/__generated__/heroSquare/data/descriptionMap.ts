...
const descriptionMap: Record<string, string[]> = {
  ...
  swap: ['realToUSDC', 'tradeImmediately', 'usdtToUSDC', 'tradeGeneral'],
  now: ['realToUSDC', 'tradeImmediately', 'usdtToUSDC'],
  start: ['realToUSDC', 'startToday', 'tradeImmediately', 'readyToTrade', 'usdtToUSDC'],
  today: ['realToUSDC', 'startToday', 'tradeImmediately', 'usdtToUSDC'],
  coin: [
    'realToUSDC',
    'futures',
  ...
  stablecoin: ['realToUSDC', 'usdtToUSDC', 'stablecoin'],
  stable: ['realToUSDC', 'stableValue', 'usdtToUSDC', 'stablecoin'],
  wallet: [
    'walletConfirmation',
    'walletWarning',
    'cryptoWallet',
  ...
  success: ['walletConfirmation', 'documentSuccess', 'rocket', 'readyToTrade', 'success'],
  confirmation: ['walletConfirmation', 'walletWarning', 'coinCheckmark', 'success', 'bigWarning'],
  positive: ['walletConfirmation', 'rocket', 'faceMatchReal', 'success', 'private'],
