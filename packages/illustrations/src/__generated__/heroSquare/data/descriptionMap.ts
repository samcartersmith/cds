...
const descriptionMap: Record<string, string[]> = {
  ...
  '2FA': ['instoAdd2Fa', 'add2Fa', 'phoneNumber'],
  Secure: ['instoAdd2Fa', 'add2Fa', 'idVerificationSecure'],
  security: [
    'instoAdd2Fa',
    'instoWalletSecurity',
    'walletSecurity',
  ...
  two: ['instoAdd2Fa', 'add2Fa', 'twoIdVerify', 'bridge', 'layerTwo'],
  factor: ['instoAdd2Fa', 'add2Fa'],
  authentication: ['instoAdd2Fa', 'add2Fa'],
  safe: ['instoAdd2Fa', 'add2Fa', 'coinbaseOneSavingFunds'],
  safety: ['instoAdd2Fa', 'add2Fa', 'securityShield', 'unlockKey'],
  add: [
    'instoAdd2Fa',
    'leverage',
    'marginWarning',
  ...
  combination: ['instoAdd2Fa', 'add2Fa'],
  password: ['instoAdd2Fa', 'add2Fa', 'unlockKey'],
  eth: [
    'instoEthStakingUpsell',
    'instoEthStakingRewards',
    'ethStakingUpsell',
  ...
  upsell: ['instoEthStakingUpsell', 'ethStakingUpsell'],
  hand: [
    'instoEthStakingUpsell',
    'brdGift',
    'coinbaseCardSpend',
  ...
  '2.0': ['instoEthStakingUpsell', 'ethStakingUpsell'],
  sparkles: [
    'instoEthStakingUpsell',
    'instoPrimeStaking',
    'primeStaking',
  ...
  vote: ['instoGovernance', 'governance', 'vote', 'engagement'],
  proposal: ['instoGovernance', 'governance'],
  ballot: ['instoGovernance', 'governance', 'vote'],
  box: ['instoGovernance', 'brdGift', 'governance', 'receiveGift'],
  yes: ['instoGovernance', 'governance', 'processing', 'success', 'walletConfirmation'],
  no: ['instoGovernance', 'governance', 'noLongAddresses'],
  ...
  percent: ['instoEarnGlobe', 'defiRisk', 'coinbaseOnePercentOff', 'earnGlobe'],
  assets: [
    'instoEarnGlobe',
    'walletAsset',
    'buyFirstCrypto',
  ...
  international: ['instoEarnGlobe', 'remittances', 'earnGlobe'],
  phone: [
    'instoPhoneUnknown',
    'buyFirstCrypto',
    'referralsWalletPhones',
  ...
  'question mark': ['instoPhoneUnknown', 'phoneUnknown', 'supportAndMore'],
  '❓': ['instoPhoneUnknown', 'phoneUnknown', 'supportAndMore'],
  ...
  Coins: ['instoPrimeStaking', 'primeEarn', 'primeStaking', 'bigBtc', 'coinsInWallet', 'primeDeFi'],
