...
const descriptionMap: Record<string, string[]> = {
  ...
  lightning: ['leadingProtocol', 'coinbaseOnePhoneLightning', 'sendCryptoFaster'],
  ...
  '⚡️': ['leadingProtocol', 'coinbaseOnePhoneLightning', 'sendCryptoFaster'],
  ...
  custodial: ['borrowLoan', 'semiCustodial'],
  'semi custodial': ['borrowLoan', 'semiCustodial'],
  bank: [
    'borrowLoan',
    'creditCardExcitement',
    'uob',
