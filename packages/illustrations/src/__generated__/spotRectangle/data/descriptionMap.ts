...
const descriptionMap: Record<string, string[]> = {
  ...
  referral: ['referralsGenericCoin', 'referralsBitcoin', 'freeBtc', 'referralsCoinbaseOne'],
  avatar: [
    'referralsGenericCoin',
    'referralsBitcoin',
    'uob',
  ...
  share: ['referralsGenericCoin', 'referralsBitcoin', 'shareOnSocialMedia', 'referralsCoinbaseOne'],
  heads: ['referralsGenericCoin', 'referralsBitcoin', 'referralsCoinbaseOne'],
  people: ['referralsGenericCoin', 'referralsBitcoin', 'referralsBonus', 'referralsCoinbaseOne'],
  ...
  PFP: ['referralsGenericCoin', 'referralsBitcoin', 'digitalCollectibles', 'referralsCoinbaseOne'],
