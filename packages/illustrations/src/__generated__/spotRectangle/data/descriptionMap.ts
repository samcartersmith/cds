...
const descriptionMap: Record<string, string[]> = {
  '1': ['layeredNetworks'],
  '2': ['layeredNetworks'],
  'empty state': ['ethTradingTwo', 'emptyTrading', 'emptyNfts', 'transferFunds', 'ethTrading'],
  trading: [
    'ethTradingTwo',
    'leverage',
  ...
  exchange: ['ethTradingTwo', 'emptyTrading', 'ethTrading'],
  stake: ['eth2SendSellTwo', 'ethStakeOrWrapTwo', 'staking', 'ethStakeOrWrap', 'eth2SendSell'],
