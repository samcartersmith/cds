...
const descriptionMap: Record<string, string[]> = {
  ...
  plus: ['commerceInvoices', 'futures', 'addBank', 'coinbaseCardLock', 'coinbaseCardPocket'],
  document: [
    'commerceInvoices',
    'protectedNotes',
    'collectingNfts',
  ...
  stars: ['concierge', 'ethWrappedStakingRewards', 'ethStakingRewards', 'bigBtc', 'usdcLoan'],
  '': [
    'concierge',
    'fileYourCryptoTaxes',
    'giftBoxRewards',
  ...
  '✅': ['verifyEmail', 'walletReconnectSuccess', 'cardWaitlist', 'documentSuccess'],
  'success state': [
    'verifyEmail',
