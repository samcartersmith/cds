...
const descriptionMap: Record<string, string[]> = {
  ...
  diamond: ['target', 'gem', 'notifications', 'easyToUse', 'trusted', 'barChart', 'learn'],
  reward: ['target', 'gem', 'notifications', 'easyToUse', 'trusted', 'barChart', 'learn'],
  sparkle: [
    'target',
    'gem',
    'notifications',
  ...
  crystal: ['target', 'gem', 'notifications', 'easyToUse', 'trusted', 'barChart', 'learn'],
  '💎': [
    'target',
    'gem',
    'notifications',
  ...
  '💍': ['target', 'gem', 'notifications', 'easyToUse', 'trusted', 'barChart', 'learn'],
  '✨': [
    'target',
    'noNftFound',
    'gem',
