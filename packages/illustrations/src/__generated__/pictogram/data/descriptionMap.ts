...
const descriptionMap: Record<string, string[]> = {
  ...
  product: ['coinbaseOneProductIcon', 'complianceNavigation', 'developerPlatformNavigation'],
  ...
  asset: ['assetManagementNavigation'],
  management: ['assetManagementNavigation', 'assetManagement'],
  ...
  fees: ['assetManagementNavigation', 'gasFees', 'noAnnualFee', 'listingFees'],
  ...
  trading: ['internationalExchangeNavigation', 'trading', 'advancedTradingDesktop', 'futures'],
  compliance: ['complianceNavigation'],
  regulatory: ['complianceNavigation'],
  certified: ['complianceNavigation'],
  ribbon: ['complianceNavigation', 'learningRewardsProduct'],
  bow: ['complianceNavigation'],
  developer: ['developerPlatformNavigation'],
  platform: ['developerPlatformNavigation', 'multiPlatform'],
  navigation: ['developerPlatformNavigation', 'standWithCryptoLogoNavigation'],
  pictogram: [
