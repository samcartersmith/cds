...
const descriptionMap: Record<string, string[]> = {
  ...
  protection: ['shield', 'coinbaseOneShield', 'key', 'idVerification', 'safe'],
  ...
  security: ['shield', 'coinbaseOneShield', 'key', 'safe', 'ubiKey', 'ssnCard'],
  stake: ['wrapEth'],
  wrap: ['wrapEth'],
  ethereum: ['wrapEth', 'layerNetworks', 'ethStaking'],
  rush: ['wrapEth'],
  movement: ['wrapEth'],
  forward: ['wrapEth'],
  exciting: ['wrapEth'],
  ...
  protect: ['key', 'safe', 'googleAuthenticator', 'ubiKey'],
  key: ['key', 'ubiKey'],
  '🔑': ['key', 'lock', 'security', 'ubiKey'],
  '🗝': ['key', 'lock', 'security', 'ubiKey'],
  '🔐': ['key', 'lock', 'security', 'ubiKey'],
  '🔒': ['key', 'lock', 'security'],
  '2fa': [
  ...
  '📲': ['mobileCharts', 'multiPlatform', 'transferSend', 'addressBook'],
  some: ['partialCoins'],
  part: ['partialCoins'],
  ...
  assign: ['delegate'],
  entrust: ['delegate'],
  person: ['delegate', 'driversLicenseWheel', 'driversLicense', 'ssnCard', 'genericCountryIDCard'],
