...
const descriptionMap: Record<string, string[]> = {
  ...
  platform: ['multiPlatform', 'developerPlatformNavigation'],
  ...
  navigation: ['standWithCryptoLogoNavigation', 'developerPlatformNavigation'],
  nav: ['standWithCryptoLogoNavigation'],
  switcher: ['standWithCryptoLogoNavigation'],
  ribbon: ['learningRewardsProduct', 'complianceNavigation'],
  ...
  product: ['complianceNavigation', 'coinbaseOneProductIcon', 'developerPlatformNavigation'],
