...
const descriptionMap: Record<string, string[]> = {
  ...
  warning: ['idError', 'cardDeclined', 'contactsListWarning', 'verifyInfo', 'outage'],
  '⚠️': ['idError', 'verifyInfo'],
  error: ['idError', 'cbEthWrappingUnavailable', 'cardDeclined', 'verifyInfo', 'outage'],
  ...
  latch: ['coinbaseLock'],
  blocked: ['coinbaseLock', 'cardBlocked'],
  '🔒': ['coinbaseLock'],
  '🔐': ['coinbaseLock'],
  '🔑': ['coinbaseLock'],
  '🗝': ['coinbaseLock'],
