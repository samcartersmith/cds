...
const descriptionMap: Record<string, string[]> = {
  '1': ['layeredNetworks'],
  '2': ['layeredNetworks'],
  clipboard: ['refresh', 'nuxChecklist', 'onTheList', 'verifyInfo'],
  ...
  warning: ['refresh', 'cardDeclined', 'contactsListWarning', 'verifyInfo', 'idError', 'outage'],
  error: ['refresh', 'cbEthWrappingUnavailable', 'cardDeclined', 'verifyInfo', 'idError', 'outage'],
  issue: ['refresh', 'verifyInfo'],
  concern: ['refresh', 'verifyInfo'],
  '⚠️': ['refresh', 'verifyInfo', 'idError'],
  'warning state': ['refresh', 'frameEmpty', 'offersEmpty', 'contactsListWarning', 'verifyInfo'],
  asset: [
    'unsupportedAsset',
