...
const descriptionMap: Record<string, string[]> = {
  ...
  grow: ['coinbaseOneEarn', 'earn', 'invest', 'guideNftDefi'],
  invest: ['coinbaseOneEarn', 'earn', 'invest', 'recommendInvestments'],
  money: [
    'coinbaseOneEarn',
    'p2pPayments',
    'crossBorderPayments',
  ...
  future: ['coinbaseOneEarn', 'earn', 'futures'],
  asset: [
    'unsupportedAsset',
  ...
  blue: ['sidechain', 'shareOnSocialMedia', 'cardDeclined', 'addCard', 'cardBlocked', 'coinFifty'],
  hex: ['blockchain'],
  block: ['blockchain'],
  network: [
    'blockchain',
