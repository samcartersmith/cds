...
const descriptionMap: Record<string, string[]> = {
  ...
  reward: ['moneyRewards', 'coinbaseOneStaking', 'ethStaking', 'rewardExpiring', 'yieldCenterUSDC'],
  eth: [
    'ethStakingRewards',
    'layeredNetworks',
    'poweredByEthereum',
  ...
  staking: ['ethStakingRewards', 'coinbaseOneStaking', 'staking', 'ethStaking', 'defiHow'],
  ...
  circle: ['futures'],
  switch: ['advancedTrading', 'switchReward', 'switchAdvancedToSimpleTrading', 'tradeImmediately'],
  ...
  warning: ['cardDeclined', 'contactsListWarning', 'verifyInfo', 'idError', 'outage'],
  ship: ['cardShipped'],
  shipped: ['cardShipped'],
  confirm: [
    'confirmAddress',
