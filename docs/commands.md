...
| ----                                         | ----                                                         |
| yarn nx run playground:format                | Format the `mobile-playground`                               |
| yarn nx run playground:start-metro           | Start the playground metro server.                           |
| yarn nx run playground:start-ios             | Start the playground ios app.                                |
| yarn nx run playground:build-ios             | Build the playground ios app.                                |
| yarn nx run playground:start-ios --clean     | Clean ios build                                              |
| yarn nx run playground:start-android         | Start the playground android app.                            |
| yarn nx run playground:build-android         | Build the playground android app.                            |
| yarn nx run playground:start-android --clean | Clean android build                                          |
| yarn nx run playground:ios-e2e --debug       | Run the ios e2e visreg tests in debug mode                   |
| yarn nx run playground:android-e2e --debug   | Run the android e2e visreg tests in debug mode               |
