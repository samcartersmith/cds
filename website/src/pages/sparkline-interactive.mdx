...
export const SparklineInteractivePrice = memo(({ defaultPeriod, ...props }: SparklineInteractivePriceProps) => {
...
export const SparklineInteractivePriceWithHeader = memo(({ defaultPeriod, ...props }: SparklineInteractivePriceProps) => {
