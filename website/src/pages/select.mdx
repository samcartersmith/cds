  ...
  return (
    <ExampleWithThemeToggles>
      <VStack gap={2} minHeight={500}>
        <HStack gap={1}>
          <Select width={200} value={year} onChange={setYear} placeholder="Year">
            {years.map((option) => (
              <MenuItem value={option} key={option}>
                <SelectOption title={option} description="BTC" selected={option === year} />
              </MenuItem>
            ))}
          </Select>
          <Select width={200} value={asset} onChange={setAsset} placeholder="Assets">
            {currencies.map((option) => (
              <MenuItem value={option} key={option}>
                <SelectOption title={option} description="BTC" selected={option === asset} />
              </MenuItem>
            ))}
          </Select>
        </HStack>
      ...
      <VStack gap={2} minHeight={700} background="background">
        ...
        <Select value={accountType} onChange={handleAccountTypeChange}>
          {accountTypeOptions.map((option) => (
            <MenuItem value={option} key={option}>
              <SelectOption description={option} selected={accountType === option} />
            </MenuItem>
          ))}
        </Select>
