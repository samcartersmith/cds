  ...
  return (
    <ExampleWithThemeToggles>
      <VStack gap={2} minHeight={500}>
        <HStack gap={1}>
          <Select width="50%" value={year} onChange={setYear} placeholder="Year">
            {years.map((option) => (
              <SelectOption
                value={option}
                key={option}
          ...
          <Select width="50%" value={asset} onChange={setAsset} placeholder="Assets">
...
function FormExample() {
  ...
  return (
    <form onSubmit={handleSubmit} action={undefined}>
      <VStack gap={2} spacing={2} minHeight={700} background="background">
