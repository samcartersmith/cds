...
<Box spacing={3} width="100%">
    <PriceChart data={interactiveSparklineData} strokeColor="#F7931A" />
</Box>
```
...
```jsx live
<Box spacing={3} width="100%">
    <PriceChart data={interactiveSparklineData} fill strokeColor="#F7931A" />
</Box>
```
...
```jsx live
<Box spacing={3} width="100%">
    <PriceChart data={interactiveSparklineData} compact strokeColor="#F7931A" />
</Box>
```
...
```jsx live
<Box spacing={3} width="100%">
    <PriceChart data={interactiveSparklineData} hidePeriodSelector strokeColor="#F7931A" />
</Box>
```

#### With header

This example is using a PriceChartWithHeader component that has not been explained. Please see the ChartHeader component for more details.
