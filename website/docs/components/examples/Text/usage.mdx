Text is represented through multiple components and grouped into 4 variants.

### Display

Display styles are the largest typography and should be used very sparingly. Display styles supersede Title styles, so they are there for when you need to layer on more hierarchy.
