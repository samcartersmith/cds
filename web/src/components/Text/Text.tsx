...
export const TextDisplay1: React.FC<TextProps> = React.memo(function TextDisplay1({
  ...
  return (
    <Tag
      ...
      className={cx(styles.graphik, styles.display1, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextDisplay2: React.FC<TextProps> = React.memo(function TextDisplay2({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.graphik, styles.display2, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextTitle1: React.FC<TextProps> = React.memo(function TextTitle1({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.graphik, styles.title1, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextTitle2: React.FC<TextProps> = React.memo(function TextTitle2({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.graphik, styles.title2, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextTitle3: React.FC<TextProps> = React.memo(function TextTitle3({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.graphik, styles.title3, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextHeadline: React.FC<TextProps> = React.memo(function TextHeadline({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.inter, styles.headline, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextBody: React.FC<TextProps> = React.memo(function TextBody({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.inter, styles.body, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextLabel1: React.FC<TextProps> = React.memo(function TextLabel1({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.inter, styles.label1, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextLabel2: React.FC<TextProps> = React.memo(function TextLabel2({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.inter, styles.label2, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextCaption: React.FC<TextProps> = React.memo(function TextCaption({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.inter, styles.caption, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
...
export const TextLegal: React.FC<TextProps> = React.memo(function TextLegal({
  ...
  return (
    <Tag
      style={{ display, color, textAlign }}
      className={cx(styles.inter, styles.legal, !wrap && noLineWrap, tnum && tabularNumber)}
    >
      {children}
    </Tag>
  );
