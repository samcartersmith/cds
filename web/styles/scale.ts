...
export const xSmall = css`
  ...
  --display1-font-family: Graphik, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto',
    'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --display2-font-size: 31px;
  --display2-line-height: 40px;
  --display2-letter-spacing: 0.014em;
  --display2-font-weight: 400;
  --display2-font-family: Graphik, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto',
    'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --title1-font-size: 25px;
  --title1-line-height: 32px;
  --title1-letter-spacing: 0;
  --title1-font-weight: 500;
  --title1-font-family: Graphik, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto',
    'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --title2-font-size: 25px;
  --title2-line-height: 32px;
  --title2-letter-spacing: 0;
  --title2-font-weight: 400;
  --title2-font-family: Graphik, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto',
    'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --title3-font-size: 17px;
  --title3-line-height: 24px;
  --title3-letter-spacing: -0.026em;
  --title3-font-weight: 500;
  --title3-font-family: Graphik, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto',
    'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --headline-font-size: 14px;
  --headline-line-height: 20px;
  --headline-letter-spacing: -0.011em;
  --headline-font-weight: 600;
  --headline-font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto',
    'Helvetica', 'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --body-font-size: 14px;
  --body-line-height: 20px;
  --body-letter-spacing: -0.011em;
  --body-font-weight: 400;
  --body-font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica',
  ...
  --label1-font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica',
    'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  ...
  --label2-font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica',
    'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  ...
  --caption-font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica',
    'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --legal-font-size: 10px;
  --legal-line-height: 12px;
  --legal-letter-spacing: 0.014em;
  --legal-font-weight: 400;
  --legal-font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica',
    'Arial', sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol';
  --spacing-0\\.5: 4px;
  --spacing-1: 8px;
  --spacing-2: 12px;
