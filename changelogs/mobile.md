...
- Added styles prop for PageHeader. [[#91](https://github.cbhq.net/frontend/cds-next/pull/91)] [[DX-4667](https://jira.coinbase-corp.com/browse/DX-4667)]
...
- Fixing the borderRadius and borderWidth for Checkbox. [[#111](https://github.cbhq.net/frontend/cds-next/pull/111)] [[DX-4925](https://jira.coinbase-corp.com/browse/DX-4925)]
...
- Add code connect files to SlideButton. [[#106](https://github.cbhq.net/frontend/cds-next/pull/106)]
...
- Version bump to align with cds-common and cds-web.
...
- Add style prop to CheckboxGroup.

## 7.6.7 (2/4/2025 PST)

#### 🐞 Fixes

- Deprecated PressableOpacity. [[#3554](https://github.cbhq.net/frontend/cds/pull/3554)]

## 7.6.6 ((2/3/2025, 02:57 PM PST))

This is an artificial version bump with no new change.

## 7.6.5 ((2/3/2025, 09:21 AM PST))
...
## 6.47.3 ((10/21/2024, 01:56 PM PST))
...
## 6.44.1 (10/1/2024 PST)

#### 🐞 Fixes

- Fix chip border bug inside Tray. [[DX-4275](https://jira.coinbase-corp.com/browse/DX-4275)]
...
## 6.37.0 ((9/4/2024, 12:10 PM PST))

This is an artificial version bump with no new change.

## 6.36.0 ((8/29/2024, 10:40 AM PST))
...
- Fix toast not responsive on Android. [[#3211](https://github.cbhq.net/frontend/cds/pull/3211)] [[DX-4189](https://jira.coinbase-corp.com/browse/DX-4189)]
...
## 6.34.1 ((8/22/2024, 11:38 AM PST))

This is an artificial version bump with no new change.

## 6.34.0 ((8/19/2024, 12:16 PM PST))

This is an artificial version bump with no new change.

## 6.33.0 ((8/19/2024, 11:44 AM PST))
...
## 6.15.0 (5/14/2024 PST)

#### 🚀 Updates

- Update(Expo): Upgrade to SDK 50. [[#2962](https://github.cbhq.net/frontend/cds/pull/2962)] [[DX-3277](https://jira.coinbase-corp.com/browse/DX-3277)]
...
- Tray: Fix title pushes down StickyFooter with long content. [[#2849](https://github.cbhq.net/frontend/cds/pull/2849)] [[DX-3454](https://jira.coinbase-corp.com/browse/DX-3454)]

## 6.2.0 ((3/12/2024, 08:56 AM PST))

This is an artificial version bump with no new change.

## 6.2.0-beta.0 ((3/11/2024, 11:03 AM PST))
...
- [trivial] chore: removed frontier toggle from mobile-app example to reduce CLS.

## 5.31.3 ((1/30/2024, 02:05 PM PST))
...
## 5.24.2 ((1/4/2024, 02:05 PM PST))

This is an artificial version bump with no new change.

## 5.24.1 ((1/2/2024, 10:55 AM PST))

This is an artificial version bump with no new change.

## 5.24.0 (12/22/2023 PST)

#### 🚀 Updates

- Feat: shimmed replacement props for v5 deprecations. [[#2577](https://github.cbhq.net/frontend/cds/pull/2577)]

## 5.23.2 ((12/20/2023, 02:22 PM PST))

This is an artificial version bump with no new change.

## 5.23.1 ((12/18/2023, 11:50 AM PST))

This is an artificial version bump with no new change.

## 5.23.0 ((12/13/2023, 10:08 AM PST))
...
## 5.17.1 ((11/17/2023, 05:16 AM PST))
...
- Bump rn(0.72.5) and expo(49.0.16). [[#2386](https://github.cbhq.net/frontend/cds/pull/2386)]
...
## 5.5.1 ((8/23/2023, 02:26 PM PST))

This is an artificial version bump with no new change.

## 5.5.0 ((8/22/2023, 09:45 AM PST))
...
- Exposed package version via `import { version } from '@cbhq/cds-mobile/version'`. [[#2175](https://github.cbhq.net/frontend/cds/pull/2175)]
...
- Add missing Animated mock. [[#2142](https://github.cbhq.net/frontend/cds/pull/2142)] [[DX-1760](https://jira.coinbase-corp.com/browse/DX-1760)]
...
- **[illustrations]** Cleanup old illustrations pipeline. [#1659](https://github.cbhq.net/frontend/cds/pull/1659)
...
- **[Illustrations]** Update illustrationSpectrumMap to alphabetize. [#1465](https://github.cbhq.net/frontend/cds/pull/1465), [CDS-2992](https://jira.coinbase-corp.com/browse/CDS-2992)
- **[Illustrations]** Alphabetize order of illustration name data. [#1461](https://github.cbhq.net/frontend/cds/pull/1461), [CDS-2992](https://jira.coinbase-corp.com/browse/CDS-2992)
- **[Carousel]** Disable scrollToEnd animation to fix the dismissing last item issue on Android. [#1456](https://github.cbhq.net/frontend/cds/pull/1456), [CDS-2942](https://jira.coinbase-corp.com/browse/CDS-2942)
...
- **[RemoteImage]** Dimensions were not being passed to RemoteImage when Svg (mobile only). [#1236](https://github.cbhq.net/frontend/cds/pull/1236), [CDS-2514](https://jira.coinbase-corp.com/browse/CDS-2514)
...
- Reanimated & gesture-handler upgrade with sparkline fix. [#1215](https://github.cbhq.net/frontend/cds/pull/1215), [IM-7087](https://jira.coinbase-corp.com/browse/IM-7087)
...
- Added loading states to pressable. [#1195](https://github.cbhq.net/frontend/cds/pull/1195)
...
- Stabilize animation methods on mobile. [#1194](https://github.cbhq.net/frontend/cds/pull/1194)
- Bump d3-color to resolve vulnerability issue. [#1178](https://github.cbhq.net/frontend/cds/pull/1178)
- **[A11y Engine]** Fix related test script coverage & mkdir output file command. [#1158](https://github.cbhq.net/frontend/cds/pull/1158)
...
- **[Carousel]** Fix Carousel mobile accessibility error. Wrapped stories in SafeAreaProvider. [#925](https://github.cbhq.net/frontend/cds/pull/925)
...
- **[Mobile Visual Regression Tests]** Refactor SDK to make ready for publishing. [#910](https://github.cbhq.net/frontend/cds/pull/910)
...
- **[illustrations]** Publish 06/08/22 [mm/dd/yy] Illo. [#638](https://github.cbhq.net/frontend/cds/pull/638)
- Moved disable state to VStack the root level, so label is also disabled. [#643](https://github.cbhq.net/frontend/cds/pull/643)
- **[Modal]** Prevent Modal animation from overridden. [#607](https://github.cbhq.net/frontend/cds/pull/607)

#### 📘 Misc

- Move react native gesture handler to peer dependency. [#618](https://github.cbhq.net/frontend/cds/pull/618)
- **[Dots]** Update documentation based on Design request. Add comments for improvements. [#617](https://github.cbhq.net/frontend/cds/pull/617)
...
- () fixed transparentWhileInactive. [#257](https://github.cbhq.net/frontend/cds/pull/257)
...
- Upgrade to react-native-lottie 5. [#205](https://github.cbhq.net/frontend/cds/pull/205)
...
- **[TextInput, SearchInput]** Input breaks when surrounded with flex. [#72](https://github.cbhq.net/frontend/cds/pull/72), [CDS-2185](https://jira.coinbase-corp.com/browse/CDS-2185)
...
- Sanitize value for mobile select. [#58299](https://github.cbhq.net/mono/repo/pull/58299)
