...
- Update IconSheet story colors for dark mode.

## 8.8.4 (9/4/2025 PST)

#### 🐞 Fixes

- Remove onChange call from usePagination hook. [[#173](https://github.cbhq.net/frontend/cds-next/pull/173)] [[DX-4934](https://jira.coinbase-corp.com/browse/DX-4934)]

## 8.8.3 (9/3/2025 PST)

#### 🐞 Fixes

- Update add-cds7-exports script.

## 8.8.2 (9/3/2025 PST)

#### 🐞 Fixes

- Fix add-cds7-exports script buffer overflow issue.

## 8.8.1 (9/3/2025 PST)

#### 🐞 Fixes

- Update radio cell default width. [[#165](https://github.cbhq.net/frontend/cds-next/pull/165)]

## 8.8.0 (8/22/2025 PST)

#### 🚀 Updates

- Add CheckboxCell, RadioCell & ControlGroup. Deprecated CheckboxGroup and RadioGroup in favor of Control Group. [[#47](https://github.cbhq.net/frontend/cds-next/pull/47)]

## 8.7.2 (8/21/2025 PST)

#### 🐞 Fixes

- Fix FullscreenModalHeader logo prop for mobile devices.

## 8.7.1 (8/21/2025 PST)

#### 🐞 Fixes

- Update export of getIconSourceSize within Icon. [[#156](https://github.cbhq.net/frontend/cds-next/pull/156)]

#### 📘 Misc

- Showcase all avatar sizes to storybook and docs. [[#153](https://github.cbhq.net/frontend/cds-next/pull/153)] [[DX-4948](https://jira.coinbase-corp.com/browse/DX-4948)]
- Update project build config. [[#155](https://github.cbhq.net/frontend/cds-next/pull/155)]

## 8.7.0 (8/20/2025 PST)

#### 🚀 Updates

- Update lottie-web and enable erasableSyntaxOnly.
...
- Publish v7 output from v8 packages.

## 8.4.1 (8/18/2025 PST)

#### 🐞 Fixes

- Fixed unstable alert action order by removing inappropriate mutation of memoed array. [[#127](https://github.cbhq.net/frontend/cds-next/pull/127)] [[DX-4943](https://jira.coinbase-corp.com/browse/DX-4943)]

## 8.4.0 (8/14/2025 PST)

#### 🚀 Updates

- Introduces new component: Stepper, complete with storybook examples and documentation. [[#124](https://github.cbhq.net/frontend/cds-next/pull/124)]

## 8.3.5 (8/14/2025 PST)

#### 🐞 Fixes

- Add support for SegmentedTabs in scroll containers. [[#125](https://github.cbhq.net/frontend/cds-next/pull/125)]

## 8.3.4 (8/14/2025 PST)

#### 🐞 Fixes

- Add callbacks to Carousel. [[#113](https://github.cbhq.net/frontend/cds-next/pull/113)] [[DX-4927](https://jira.coinbase-corp.com/browse/DX-4927)]

## 8.3.3 (8/12/2025 PST)

#### 🚀 Updates

- Added styles and classNames props for PageHeader. [[#91](https://github.cbhq.net/frontend/cds-next/pull/91)] [[DX-4667](https://jira.coinbase-corp.com/browse/DX-4667)]

## 8.3.2 (8/11/2025 PST)

#### 🐞 Fixes

- Remove border for DotStatusColor. [[#118](https://github.cbhq.net/frontend/cds-next/pull/118)] [[DX-4931](https://jira.coinbase-corp.com/browse/DX-4931)]

## 8.3.1 (8/11/2025 PST)

#### 🐞 Fixes

- Fixing the border Radius and borterWidth for Checkbox. [[#111](https://github.cbhq.net/frontend/cds-next/pull/111)] [[DX-4925](https://jira.coinbase-corp.com/browse/DX-4925)]

## 8.3.0 (8/6/2025 PST)

#### 🚀 Updates

- Add styles and classNames props to ProgressBar, refactoring to simplify component as well. [[#101](https://github.cbhq.net/frontend/cds-next/pull/101)]

## 8.2.9 (8/8/2025 PST)

#### 🚀 Updates

- Refactor getBlendedColor. [[#88](https://github.cbhq.net/frontend/cds-next/pull/88)]

#### 📘 Misc

- Add code connect files to Pagination. [[#106](https://github.cbhq.net/frontend/cds-next/pull/106)]
...
- Add figma code-connect files. [[#98](https://github.cbhq.net/frontend/cds-next/pull/98)]

## 8.2.6 (7/29/2025 PST)

#### 🐞 Fixes

- Add defaultFontStyles to packaage sideEffects.
...
- Fixed pressed prop not working on Interactable.

## 8.2.3 (7/21/2025 PST)

#### 🚀 Updates

- Moved helper functions back to the same file for Interactable and MediaQueryProvider. [[#79](https://github.cbhq.net/frontend/cds-next/pull/79)]

## 8.2.2 (7/21/2025 PST)

#### 🚀 Updates

- Reorganzied MediaQueryProvider, Tabs, and Interactable file structure for docs site props generation. [[#76](https://github.cbhq.net/frontend/cds-next/pull/76)]

## 8.2.1 (7/18/2025 PST)

#### 🐞 Fixes

- Set link default user select to initial. [[#72](https://github.cbhq.net/frontend/cds-next/pull/72)]

## 8.2.0 (7/17/2025 PST)

#### 🚀 Updates

- Add new Carousel component. [[#46](https://github.cbhq.net/frontend/cds-next/pull/46)]

## 8.1.3 (7/16/2025 PST)

- Version bump to align with cds-common and cds-mobile.

## 8.1.2 (7/10/2025 PST)

#### 🐞 Fixes

- Fix: add hitslop prop back to mobile IconButton. [[#49](https://github.cbhq.net/frontend/cds-next/pull/49)]
...
- Add new Tray component. [[#4093](https://github.cbhq.net/frontend/cds/pull/4093)]
...
## 8.0.0-rc.7 (6/27/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.7

## 8.0.0-rc.6 (6/13/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.6

## 8.0.0-rc.5 (6/5/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.5

## 8.0.0-rc.4 (5/16/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.4

## 8.0.0-rc.3 (5/13/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.3

## 8.0.0-rc.2 (5/9/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.2

## 8.0.0-rc.1 (5/9/2025 PST)

#### 🚀 Updates

- Release CDS v8 rc.1

## 8.0.0-alpha.8 (5/9/2025 PST)

#### 🚀 Updates

- Release CDS v8 alpha.8

## 8.0.0-alpha.7 (5/7/2025 PST)

#### 🚀 Updates

- Release CDS v8 alpha.7

## 8.0.0-alpha.6 (5/5/2025 PST)

#### 🚀 Updates

- Release CDS v8 alpha.6

## 8.0.0-alpha.5 (4/30/2025 PST)

#### 🚀 Updates

- Release CDS v8 alpha.5

## 8.0.0-alpha.4 (4/11/2025 PST)

#### 🚀 Updates

- Release CDS v8 alpha.4
...
- Release CDS v8 alpha.3

## 8.0.0-alpha.2 (3/25/2025 PST)

#### 🚀 Updates

- Release CDS v8 alpha.2
...
- Deprecated PressableOpacity and NavigationIconButton. [[#3554](https://github.cbhq.net/frontend/cds/pull/3554)]
...
## 7.6.1 ((12/17/2024, 07:17 AM PST))

This is an artificial version bump with no new change.

## 7.6.0 ((12/16/2024, 11:57 AM PST))

This is an artificial version bump with no new change.

## 7.5.0 ((12/16/2024, 10:11 AM PST))
