...
- Update add-cds7-exports script and publish.Dockerfile.
...
- Introduces a new hook: useStepper and utils to accompany the new Stepper componetn in cds-web and cds-mobile. [[#124](https://github.cbhq.net/frontend/cds-next/pull/124)]

## 8.3.5 ((8/14/2025, 8:50 AM PST))

This is an artificial version bump with no new change.

## 8.3.4 ((8/14/2025, 8:10 AM PST))

This is an artificial version bump with no new change.

## 8.3.3 ((8/12/2025, 01:47 PM PST))

This is an artificial version bump with no new change.

## 8.3.2 ((8/11/2025, 10:36 AM PST))

This is an artificial version bump with no new change.

## 8.3.1 ((8/11/2025, 09:41 AM PST))

This is an artificial version bump with no new change.

## 8.3.0 ((8/6/2025, 10:00 AM PST))
...
Remove `@cbhq/mcp` as an optional dependency.
...
- Version bump to align with cds-web and cds-mobile.

## 8.2.0 ((7/17/2025, 7:20 PST))
...
- Removed unused @cbhq/client-analytics as a devDep. [[#94](https://github.cbhq.net/frontend/cds-next/pull/94)]
...
- Add new SlideButton mobile component. [[#3924](https://github.cbhq.net/frontend/cds/pull/3924)]
...
- Add new Tray for web component. [[#4093](https://github.cbhq.net/frontend/cds/pull/4093)]
- Add new TopNavBar mobile component. [[#4030](https://github.cbhq.net/frontend/cds/pull/4030)]
...
## 7.7.0 ((2/11/2025, 11:19 AM PST))

This is an artificial version bump with no new change.

## 7.6.7 ((2/4/2025, 02:45 PM PST))
...
## 6.47.2 (10/21/2024 PST)

#### 🐞 Fixes

- Fixed dot count being cutting off on TabNavigation. [[#3358](https://github.cbhq.net/frontend/cds/pull/3358)] [[DX-4316](https://jira.coinbase-corp.com/browse/DX-4316)]

## 6.47.1 ((10/10/2024, 06:12 PM PST))
...
## 6.32.0 ((8/19/2024, 10:02 AM PST))

This is an artificial version bump with no new change.

## 6.31.0 ((8/15/2024, 09:59 AM PST))
...
- Add useDateInput and IntlDateFormat. [[#2848](https://github.cbhq.net/frontend/cds/pull/2848)] [[DX-3004](https://jira.coinbase-corp.com/browse/DX-3004)]
...
- Fix typo. [[#3034](https://github.cbhq.net/frontend/cds/pull/3034)]
...
- Add alpha banner props and tokens. [[#3000](https://github.cbhq.net/frontend/cds/pull/3000)] [[DX-3684](https://jira.coinbase-corp.com/browse/DX-3684)]

## 6.13.2 ((5/9/2024, 03:17 PM PST))
...
## 6.8.4 ((4/23/2024, 12:34 PM PST))

This is an artificial version bump with no new change.

## 6.8.3 ((4/19/2024, 04:17 PM PST))
...
- Fix palette overrides. [[#2943](https://github.cbhq.net/frontend/cds/pull/2943)]
...
- **[Alert, ListCellFallback, Modal, SparklineInteractive]** Update story builders for better Visreg compatibility. [[#2759](https://github.cbhq.net/frontend/cds/pull/2759)] [[DX-3119](https://jira.coinbase-corp.com/browse/DX-3119)]
...
- Undeprecated getButtonSpacing.

## 5.31.3 ((1/30/2024, 02:05 PM PST))

This is an artificial version bump with no new change.

## 5.31.2 ((1/29/2024, 11:30 PM PST))
...
## 5.19.0 ((11/21/2023, 09:43 AM PST))
...
- Export dotCountSize. [[#2405](https://github.cbhq.net/frontend/cds/pull/2405)] [[DX-2514](https://jira.coinbase-corp.com/browse/DX-2514)]
...
## 5.16.4 ((10/25/2023, 09:51 AM PST))
...
## 5.11.1 (9/15/2023 PST)

#### 🐞 Fixes

- Deprecated frontier flags. [[#2264](https://github.cbhq.net/frontend/cds/pull/2264)] [[DX-2297](https://jira.coinbase-corp.com/browse/DX-2297)]
...
- Update createCardMedia to use Pictogram and SpotSquare components. [[#2200](https://github.cbhq.net/frontend/cds/pull/2200)] [[DX-813](https://jira.coinbase-corp.com/browse/DX-813)]
...
- Add DotDynamic story for testing animation.
...
- Add testID to LottieStatusAnimationProps. [[#2001](https://github.cbhq.net/frontend/cds/pull/2001)] [[DX-1071](https://jira.coinbase-corp.com/browse/DX-1071)]
...
- **[SparklineInteractiveHeader]** Update spec for 4 data points. [#1455](https://github.cbhq.net/frontend/cds/pull/1455)
...
- **[ListCell]** Clarify usage of detail and subdetail props. [#1410](https://github.cbhq.net/frontend/cds/pull/1410), [CDS-2659](https://jira.coinbase-corp.com/browse/CDS-2659)
- **[Changelogs]** Fix update incorrectly categorized as a fix. [#1397](https://github.cbhq.net/frontend/cds/pull/1397)
...
- **[Testing]** Add tests for low coverage files in cds-common. [#1061](https://github.cbhq.net/frontend/cds/pull/1061)
...
- **[⌨ Sparkline]**: Support keyboard interactions. [#960](https://github.cbhq.net/frontend/cds/pull/960), [CDS-2341](https://jira.coinbase-corp.com/browse/CDS-2341)
- **[Mobile-Accessibility]** Fix remaining issues with a11y/mobile.test.tsx. [#959](https://github.cbhq.net/frontend/cds/pull/959)
- **[Toast]** Fix duplicate removeToast call. [#958](https://github.cbhq.net/frontend/cds/pull/958)
...
- UseCounter tests. [#43117](https://github.cbhq.net/mono/repo/pull/43117)
...
## 0.29.0 (11/15/2021, 04:01 PM PST)
...
## 0.26.1 (10/20/2021, 09:07 AM PST)
...
- Added ForegroundMuted variant to IconButton. [#21287](https://github.cbhq.net/mono/repo/pull/21287)
