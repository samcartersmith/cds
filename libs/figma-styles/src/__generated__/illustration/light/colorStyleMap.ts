...
const colorStyleMap = {
  ...
  'gray-2': {
    key: '61739a0f18f3f51f9428261fe0577ee063046609',
    name: 'gray-2',
    type: 'light',
    prefix: 'illustration',
    paint: { type: 'solid', value: '#0A0B0F' },
    cssVarSetter: '--illustration-gray-2',
    cssVarGetter: 'var(--illustration-gray-2)',
  },
  'gray-3': {
    key: '078d6f95fa3fd0e4a74436b1037dc61f05d16c6c',
    name: 'gray-3',
    type: 'light',
    prefix: 'illustration',
    paint: { type: 'solid', value: '#CED2DC' },
