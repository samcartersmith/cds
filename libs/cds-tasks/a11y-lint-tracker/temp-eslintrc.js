// .eslintrc.js for for web + mobile combined
module.exports = {
  parser: '@typescript-eslint/parser', // Specifies the ESLint parser
  plugins: ['react-native-a11y', 'jsx-a11y', '@cbhq', '@cbhq/cds'],
  extends: [
    'plugin:jsx-a11y/strict',
    'plugin:react-native-a11y/all',
    'plugin:@cbhq/cds/web',
    'plugin:@cbhq/cds/mobile',
  ], // 'plugin:@cbhq/cds/web', 'airbnb/rules/react-a11y'
  root: true,
  parserOptions: {
