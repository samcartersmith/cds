...
const templates = {
  'packages/common/src/types/Scale.ts': {
    types: {
      Scale: scales,
  ...
  'packages/common/src/types/Spectrum.ts': {
    types: {
  ...
  'packages/common/src/types/Typography.ts': {
    types: {
      Typography: Object.keys(typographyConfig),
    },
  },
  'packages/common/src/types/SpacingScale.ts': {
    types: {
      SpacingScale: spacingScale,
    },
  },
  'packages/common/src/types/AvatarSize.ts': {
    types: {
