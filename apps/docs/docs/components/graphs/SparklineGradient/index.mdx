...
import webPropsToc from ':docgen/web-visualization2/sparkline/SparklineGradient/toc-props';
import mobilePropsToc from ':docgen/mobile-visualization2/sparkline/SparklineGradient/toc-props';
...
<VStack gap={5}>
  <ComponentHeader
    ...
    webMetadata={{
      import: "import { SparklineGradient } from '@cbhq/cds-web-visualization'",
      source:
        'https://github.cbhq.net/frontend/cds/blob/master/packages/web-visualization/src/sparkline/SparklineGradient.tsx',
      storybook:
    ...
    mobileMetadata={{
      import: "import { SparklineGradient } from '@cbhq/cds-mobile-visualization'",
      source:
        'https://github.cbhq.net/frontend/cds/blob/master/packages/mobile-visualization/src/sparkline/SparklineGradient.tsx',
      figma:
        'https://www.figma.com/design/k5CtyJccNQUGMI5bI4lJ2g/%E2%9C%A8-CDS-Components?node-id=155-12194',
    }}
  />
