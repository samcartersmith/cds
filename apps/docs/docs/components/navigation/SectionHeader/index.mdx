...
import webPropsToc from ':docgen/cds-web2/section-header/SectionHeader/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/section-header/SectionHeader/toc-props';
