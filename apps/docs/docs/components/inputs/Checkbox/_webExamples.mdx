...
function CheckboxDemo() {
  ...
  return (
    <Checkbox value="hyped" onChange={(e) => setIsChecked(e.target.checked)} checked={isChecked}>
...
For more advanced color customization, you can use additional style props like `background` and `borderColor`:
