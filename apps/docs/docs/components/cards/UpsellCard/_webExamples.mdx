...
function Example() {
  ...
  const textColor = colorScheme === 'light' ? 'white' : 'black';
  return (
      ...
      {cards.map((card) => {
        return (
          <UpsellCard
            {...card}
            title={
              <TextHeadline dangerouslySetColor={textColor} as="h3">
                {card.title}
              </TextHeadline>
            }
            description={
              <TextLabel2 as="p" numberOfLines={3} dangerouslySetColor={textColor}>
                {card.description}
              </TextLabel2>
            }
          />
...
function Example() {
  ...
  const textColor = colorScheme === 'light' ? 'white' : 'black';
  return (
    <VStack minHeight={300} spacing={2} alignItems="center" justifyContent="center" gap={1}>
      {cards.map((card) => {
        return (
          <UpsellCard
            {...card}
