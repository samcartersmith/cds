...
import webPropsToc from ':docgen/cds-web2/cards/ContentCard/ContentCardFooter/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/cards/ContentCard/ContentCardFooter/toc-props';
...
<VStack gap={5}>
  <ComponentHeader
    ...
    webMetadata={{
      import: "import { ContentCardFooter } from '@cbhq/cds-web/cards/ContentCard'",
      source:
        'https://github.cbhq.net/frontend/cds/blob/master/packages/web/src/cards/ContentCard/ContentCardFooter.tsx',
      storybook:
    ...
    mobileMetadata={{
      import: "import { ContentCardFooter } from '@cbhq/cds-mobile/cards/ContentCard'",
      source:
        'https://github.cbhq.net/frontend/cds/blob/master/packages/mobile/src/cards/ContentCard/ContentCardFooter.tsx',
      figma:
        'https://www.figma.com/file/k5CtyJccNQUGMI5bI4lJ2g/%E2%9C%A8-Normal-CDS-Components?type=design&node-id=61%3A589&mode=design&t=VY6cW5sQK2K2giAk-1',
    }}
  />
