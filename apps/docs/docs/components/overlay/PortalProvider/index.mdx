...
import mobilePropsToc from ':docgen/cds-mobile2/overlays/PortalProvider/toc-props';
import WebPropsTable from './_webPropsTable.mdx';
import webPropsToc from ':docgen/cds-web2/overlays/PortalProvider/toc-props';
