...
import mobilePropsToc from ':docgen/cds-mobile2/overlays/modal/ModalFooter/toc-props';
import WebPropsTable from './_webPropsTable.mdx';
import webPropsToc from ':docgen/cds-web2/overlays/modal/ModalFooter/toc-props';
...
<VStack gap={5}>
  <ComponentHeader
    title="ModalFooter"
    webMetadata={{
      import: "import { ModalFooter } from '@cbhq/cds-web/overlays/modal/ModalFooter'",
      source: 'https://github.cbhq.net/frontend/cds/blob/master/packages/web/src/overlays/Modal/ModalFooter.tsx',
    ...
    mobileMetadata={{
      import: "import { ModalFooter } from '@cbhq/cds-mobile/overlays/modal/ModalFooter'",
      source: 'https://github.cbhq.net/frontend/cds/blob/master/packages/mobile/src/overlays/Modal/ModalFooter.tsx',
      figma: 'https://www.figma.com/design/k5CtyJccNQUGMI5bI4lJ2g/%E2%9C%A8-CDS-Components?node-id=68-1053'
    }}
    banner={<ModalBanner />}
  />
