...
import mobilePropsToc from ':docgen/cds-mobile2/overlays/modal/ModalBody/toc-props';
import WebPropsTable from './_webPropsTable.mdx';
import webPropsToc from ':docgen/cds-web2/overlays/modal/ModalBody/toc-props';
...
<VStack gap={5}>
  <ComponentHeader
    title="ModalBody"
    webMetadata={{
      import: "import { ModalBody } from '@cbhq/cds-web/overlays/modal/ModalBody'",
      source: 'https://github.cbhq.net/frontend/cds/blob/master/packages/web/src/overlays/Modal/ModalBody.tsx',
    ...
    mobileMetadata={{
      import: "import { ModalBody } from '@cbhq/cds-mobile/overlays/modal/ModalBody'",
      source: 'https://github.cbhq.net/frontend/cds/blob/master/packages/mobile/src/overlays/Modal/ModalBody.tsx',
      figma: 'https://www.figma.com/design/k5CtyJccNQUGMI5bI4lJ2g/%E2%9C%A8-CDS-Components?node-id=68-1053'
    }}
    banner={<ModalBanner />}
  />
