...
import webPropsToc from ':docgen/cds-web2/overlays/overlay/Overlay/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/overlays/overlay/Overlay/toc-props';
