...
import webPropsToc from ':docgen/cds-web2/visualizations/ProgressBarWithFixedLabels/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/visualizations/ProgressBarWithFixedLabels/toc-props';
