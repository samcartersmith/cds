...
import webPropsToc from ':docgen/cds-web2/visualizations/ProgressBar/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/visualizations/ProgressBar/toc-props';
