...
import webPropsToc from ':docgen/cds-web2/visualizations/ProgressBarWithFloatLabel/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/visualizations/ProgressBarWithFloatLabel/toc-props';
