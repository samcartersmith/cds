...
import webPropsToc from ':docgen/cds-web2/visualizations/ProgressCircle/toc-props';
import mobilePropsToc from ':docgen/cds-mobile2/visualizations/ProgressCircle/toc-props';
