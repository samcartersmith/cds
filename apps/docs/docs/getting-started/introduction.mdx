...
<ComponentHeader
  title="Introduction"
  description="Welcome to the Coinbase Design System (CDS) documentation! CDS is a cross-platform component library built with TypeScript, designed to streamline the development of React and React Native applications. It empowers developers with consistent, reusable, and accessible components that adhere to Coinbase's design principles."
