...
<ComponentHeader
  title="Styling"
  description="Styling with the Coinbase Design System (CDS) is designed to be intuitive, efficient, and consistent. CDS provides a flexible styling API that leverages both CSS Variables (for web) and dynamic React Context-based theming (for React Native)."
...
<ul>
  <li>
    <strong>CSS Variables</strong>: CDS components use CSS Variables to style elements efficiently.
  </li>
  <li>
    <strong>Dynamic Updates</strong>: Switching themes (e.g., light and dark mode) dynamically
    updates styles.
  </li>
</ul>
...
<ul>
  ...
  <li>
    <strong>Dynamic Props</strong>: Apply inline styles using CSS Variables (web) or the{' '}
    <code>StyleSheet</code> API (React Native).
  </li>
</ul>
