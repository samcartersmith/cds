...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/assethub-admin/stats.json')}
>
  <AdopterProjectInfoProvider
    {...require(':cds-website/static/data/__generated__/adoption/assethub-admin/info.json')}
  >
    <AdopterComponentsProvider
      {...require(':cds-website/static/data/__generated__/adoption/assethub-admin/components.json')}
    >
      <AdopterDetails />
    </AdopterComponentsProvider>
  </AdopterProjectInfoProvider>
