...
title: Help Center Web
sidebar_label: Help Center Web
---
...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/helpcenter-web/stats.json')}
>
  <AdopterProjectInfoProvider
    {...require(':cds-website/static/data/__generated__/adoption/helpcenter-web/info.json')}
  >
    <AdopterComponentsProvider
      {...require(':cds-website/static/data/__generated__/adoption/helpcenter-web/components.json')}
    >
      <AdopterDetails />
    </AdopterComponentsProvider>
  </AdopterProjectInfoProvider>
