...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/abor/stats.json')}
>
  <AdopterProjectInfoProvider
    {...require(':cds-website/static/data/__generated__/adoption/abor/info.json')}
  >
    <AdopterComponentsProvider
      {...require(':cds-website/static/data/__generated__/adoption/abor/components.json')}
    >
      <AdopterDetails />
    </AdopterComponentsProvider>
  </AdopterProjectInfoProvider>
