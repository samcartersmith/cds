...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/commerce-web/stats.json')}
>
  <AdopterProjectInfoProvider
    {...require(':cds-website/static/data/__generated__/adoption/commerce-web/info.json')}
  >
    <AdopterComponentsProvider
      {...require(':cds-website/static/data/__generated__/adoption/commerce-web/components.json')}
    >
      <AdopterDetails />
    </AdopterComponentsProvider>
  </AdopterProjectInfoProvider>
