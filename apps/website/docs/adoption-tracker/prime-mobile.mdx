...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/prime-mobile/stats.json')}
>
  <AdopterProjectInfoProvider
    {...require(':cds-website/static/data/__generated__/adoption/prime-mobile/info.json')}
  >
    <AdopterComponentsProvider
      {...require(':cds-website/static/data/__generated__/adoption/prime-mobile/components.json')}
    >
      <AdopterDetails />
    </AdopterComponentsProvider>
  </AdopterProjectInfoProvider>
