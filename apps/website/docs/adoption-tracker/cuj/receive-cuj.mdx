...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/cuj/summary/receive-cuj/stats.json')}
>
  <AdopterComponentsProvider
    {...require(':cds-website/static/data/__generated__/adoption/cuj/summary/receive-cuj/components.json')}
  >
    <CUJDetails id={'receive-cuj'} title={'Receive'} />
  </AdopterComponentsProvider>
</AdopterStatsProvider>
