...
title: Payments On Ramp Widget
sidebar_label: Payments On Ramp Widget
---
...
<AdopterStatsProvider
  {...require(':cds-website/static/data/__generated__/adoption/payments-onramp-widget/stats.json')}
>
  <AdopterProjectInfoProvider
    {...require(':cds-website/static/data/__generated__/adoption/payments-onramp-widget/info.json')}
  >
    <AdopterComponentsProvider
      {...require(':cds-website/static/data/__generated__/adoption/payments-onramp-widget/components.json')}
    >
      <AdopterDetails />
    </AdopterComponentsProvider>
  </AdopterProjectInfoProvider>
