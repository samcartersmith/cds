...
<VStack gap={3}>
  <TextDisplay3 as="h1">TextInput</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/controls/TextInput.tsx"
    openInNewWindow
  >
    @cbhq/cds-(web|mobile)/controls/TextInput
  </Link>
  <Tabs>
