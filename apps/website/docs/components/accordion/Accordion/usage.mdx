...
<ExampleWithThemeToggles>
  <Accordion defaultActiveKey="1" onItemPress={(itemKey) => console.log(itemKey)}>
    <AccordionItem
      ...
      title="Accordion #1"
      subtitle="subtitle1"
      media={<CellMedia type="icon" name="wallet" title="BTC" />}
    >
      <TextInput
        compact
        type="number"
  ...
  <Accordion defaultActiveKey="2">
    <AccordionItem itemKey="1" title="What is a W-9 form?">
      <VStack>
        <TextLabel2 as="p" color="foregroundMuted">
          ...
          address and social security number). It should also report whether they have been
          instructed by the IRS that they are subject to backup withholding.
        </TextLabel2>
        <TextLabel2 as="p" color="foregroundMuted">
    ...
    <AccordionItem itemKey="2" title="What is backup witholding?">
      <VStack>
        ...
        <ul>
          <li>
            <TextLabel2 as="p" color="foregroundMuted">
              The account holder does not provide their name and tax identification number and
              certify that the information is correct in the manner required by the IRS prior to
              receiving reportable payments including dividends, interest, and gross proceeds from
              sale transactions.
            </TextLabel2>
          </li>
          <li>
    ...
    <AccordionItem itemKey="4" title="What is a FATCA code?">
      <VStack>
        ...
        <TextLabel2 as="p" color="foregroundMuted">
          This is not applicable to our customers because Coinbase accounts are US based and no
          FATCA code is required.
        </TextLabel2>
      </VStack>
    </AccordionItem>
  </Accordion>
