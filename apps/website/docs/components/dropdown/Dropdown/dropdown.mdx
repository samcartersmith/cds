...
<VStack gap={3}>
  <TextDisplay3 as="h1">Dropdown</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/dropdown/Dropdown.tsx"
    openInNewWindow
  >
    @cbhq/cds-web/dropdown/Dropdown
  </Link>
  <Tabs>
