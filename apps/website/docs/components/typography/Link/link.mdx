...
<VStack gap={3}>
  <TextDisplay3 as="h1">Link</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/typography/Link.tsx"
    openInNewWindow
  >
    @cbhq/cds-(web|mobile)/typography/Link
  </Link>
  <Tabs>
