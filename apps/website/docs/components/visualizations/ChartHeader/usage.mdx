#### Example code
All examples use the following code to generate the SparklineInteractive with a ChartHeader
...
<Box spacing={3} width="100%">
    <PriceChartWithHeader data={sparklineInteractiveData} strokeColor="#F7931A" />
</Box>
```
