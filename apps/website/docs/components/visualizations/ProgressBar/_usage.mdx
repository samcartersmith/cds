...
```jsx live
<VStack gap={2}>
  <ProgressBar weight="thin" progress={0} />
  <ProgressBar weight="thin" progress={0.5} />
  <ProgressBar weight="thin" progress={1} />
</VStack>
```
...
```jsx live
<VStack gap={2}>
  <ProgressBar weight="semiheavy" progress={0} />
  <ProgressBar weight="semiheavy" progress={0.5} />
  <ProgressBar weight="semiheavy" progress={1} />
</VStack>
```
