...
<VStack gap={3}>
  <TextDisplay3 as="h1">Alert</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/overlays/Alert.tsx"
    openInNewWindow
  >
    @cbhq/cds-(web|mobile)/overlays/Alert
  </Link>
  <Tabs>
