...
<VStack gap={3}>
  <TextDisplay3 as="h1">Tooltip</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/overlays/Tooltip.tsx"
    openInNewWindow
  >
    @cbhq/cds-(web|mobile)/overlays/Tooltip
  </Link>
  <Tabs>
