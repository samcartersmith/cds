...
<VStack gap={3}>
  <TextDisplay3 as="h1">DotCount</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/dots/DotCount.tsx"
    openInNewWindow
  >
    @cbhq/cds-(web|mobile)/dots/DotCount
  </Link>
  <Tabs>
