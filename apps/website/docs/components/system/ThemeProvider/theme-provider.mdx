...
<VStack gap={3}>
  <TextDisplay3 as="h1">ThemeProvider</TextDisplay3>
  <Link
    to="https://github.cbhq.net/frontend/cds/blob/master/packages/web/system/ThemeProvider.tsx"
    openInNewWindow
  >
    @cbhq/cds-(web|mobile)/system/ThemeProvider
  </Link>
  <Tabs>
