...
import type { AvatarSize, AvatarPixelSize } from '../types';

type AvatarScaleMap = Record<AvatarSize, AvatarPixelSize>;

const denseScaleMap: AvatarScaleMap = { xxxl: 48, xxl: 40, xl: 32, l: 24, m: 16 };
const normalScaleMap: AvatarScaleMap = { xxxl: 56, xxl: 48, xl: 40, l: 32, m: 24 };
